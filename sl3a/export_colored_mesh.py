...
def export_colored_mesh(mesh_config, snapshot, swap_face = False, target_size = 500000, sigma = 0.0005):
    # load snap from ngp
    ...
    cluster = clus.cluster(target_size)
    ...
    verts, faces, _ = load_obj(out_path,
                                     load_textures=False,
