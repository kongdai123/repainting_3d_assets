...
from diff_view_gen.inpaint import initialize_meshes, inpaint_first_view, inpaint_facade, write_train_transforms, \
...
def paint(mesh_config, inpaint_config, nerf_config):
    ...
    view_1, view_2, transforms_config_out = inpaint_facade(
        inpaint_config, mesh_config, pipe, latents, meshes, bg_image, transforms_config_out, device
    )
