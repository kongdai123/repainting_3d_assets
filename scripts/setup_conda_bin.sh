...
SL3A_CONDA_INSTALLER_FILE="${SL3A_CONDA_INSTALLER_FILE:-Miniconda3-py38_23.1.0-1-Linux-x86_64.sh}"
...
if [ -f "${SL3A_ROOT}/.marker.conda.completed" ]; then
...
# bash -c "${SL3A_CONDA_ROOT}/miniconda3/bin/conda init"
touch "${SL3A_ROOT}/.marker.conda.completed"
